...
export const mapping2  = {
    ...
    81: {
        name: 'next_fan_change', //general countdown untinl next fan speed change
        transform: uint32
    },
    117: {
    ...
    119: {
        name: 'exhaust_fan_flow', //m3/h
        transform: uint16
    },
    120: {
        name: 'supply_fan_flow', //m3/h
        transform: uint16
    },
    121: {
        name: 'exhaust_fan_speed', //rpm
        transform: uint16
    },
    122: {
        name: 'supply_fan_speed', //rpm
        transform: uint16
    },
    ...
    129: {
        name: 'power_consumption_ytd', // kWh
        transform: uint16,
    },
    130: {
        name: 'power_consumption_since_start', // kWh
        transform: uint16,
    },
    ...
    144: {
        name: 'ph_power_consumption_ytd', // kWh
        transform: uint16,
    },
    145: {
        name: 'ph_power_consumption_since_start', // kWh
        transform: uint16,
    },
    // clone?
    146: {
...
export const commands = {
    ...
    'ventilation_supply_only_reset':       [0x85, 0x15, 0x06, 0x01],
    'ventilation_extract_only':[0x84, 0x15, 0x07, 0x01, 0x00, 0x00, 0x00, 0x00, 0x10, 0x0e, 0x00, 0x00, 0x00],
    'ventilation_extract_only_reset':       [0x85, 0x15, 0x07, 0x01],
